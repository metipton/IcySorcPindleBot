...
namespace IcySorcPindleBot.Helpers.ItemHelper
{
    public class ItemFinder
    {
        ...
        readonly List<string> uniqueExclusion = new List<string>() { "AEGIS", "ANCIENTARMR", "ANCIENTAXE", "ANCIENTSHIELD", "ARBALEST", "ARMET", "ATAGHAN", "AXE", "BALRGSPEAR", "BARBEDCLUB", "BARBEDSHIELD", "BASTARDSWORD", "BATTLEAXE", "BATTLECESTUS", "BATTLEDART", "BATTLEHAMMER", "BATTLESCYTHE", "BATTLESTAFF", "BECDECRBIN", "BELT", "BILL", "BLADE", "BONEHELM", "BRANDISTOCK", "BREASTPLATE", "CAP", "CEDARBW", "CHAINBTS", "CHAMPINSWORD", "CHUKNU", "CINQUEDEAS", "CHAINMAIL", "CHAMPIONAXE", "CLAYMORE", "CLEAVER", "CLSCROSSBOW", "CROSSBOW", "CROWN", "CRYPTICSWORD", "CUDGEL", "CUTLESS", "DACIANFALX", "DEATHMASK", "DEATHIMMASK", "DECAPITATOR", "DEFENDER", "DEMONHIDESASH", "DEVILSTAR", "DIRK", "DIVINESCEPTER", "DOUBLEAXE", "EDGEBW", "ELDERSTAFF", "EMBOSSEDPLATE", "ESPANDN", "FERALCLAWS", "FIELDPLATE", "FLAIL", "FLAMBERGE", "FLYINGAXE", "FRANCISCA", "FULLHELM", "FULLPLATEMAIL", "FULLTPLATEIMAIL", "FUSCINA", "GHOSTARMOR", "GIANTAXE", "GIANTSWRD", "GLADIUS", "GRANDSCEPTER", "GREATAXE", "GREATHELM", "GREATSWORD", "GRIMWAND", "GOTHICAXE", "GTHICBW", "GTHICPLATE", "GOTHICSWORD", "GRANDCROWN", "GRIMSCYTHE", "HALBERD", "HEAVYBTS", "HEAVYCROSSBOW", "HELM", "HUNTERSBOW", "HYPERINSPEAR", "KITESHIELD", "KNOUT", "KRAKENSHELL", "KRIS", "ARGESHIELD", "LEGENDARYMALLET", "LIGHTBELT", "LINKEDMAIL", "LOCHABERAXE", "LNGBATTLEBW", "LONGSTAFF", "LONGSWORD", "LNGBW", "LNGWARB", "LUNA", "MACE", "MANCATCHER", "ITANCATCHER", "MARTELDEFER", "MASK", "MATRIARCHALBOW", "MORNINGSTAR", "MAUL", "NAGA", "MESHBELT", "MILITARYPICK", "OGREMAUL", "DGREMAVL", "PARTIZAN", "PAVISE", "PHASEBLADE", "PIKE", "PLATEMAIL", "POIGNARD", "POLEAXE", "RINGMAIL", "RNDEL", "RUNDSHIELD", "RUNESCEPTER", "RUNESWORD", "SABRE", "SALLET", "SASH", "SCALEMAIL", "SCUTUM", "SCYTHE", "SHADOWPLATE", "SHAMSHIR", "SHARKSKINBELT", "SHARKTOOTHARMOR", "SHRTBATTLEB", "SHORTSWORD", "SHRTWARB", "SIEGECROSSBOW", "SILVEREDGEDAXE", "SKULLCAP", "SALLSHIELD", "SPEAR", "SPIKEDCLUB", "SPIKEDSHIELD", "SPETUM", "SPLINTMAIL", "STUDDEDLEATHER", "TABAR", "TOMAHAWK", "TWERSHIELD", "TRELLISEDARMOR", "TRIDENT", "TRUNCHEON", "TWINAXE", "TWHANDEDSWORD", "TYRANTCLUB", "VULGE", "WARAXE", "WARCLUB", "WARGAUNTLETS", "WARFORK", "WARSCEPTER", "WARSPEAR", "WARSTAFF", "WARSWORD", "WINGEDAXE", "WINGEDHELM", "ZAKARUMSHIELD" };
